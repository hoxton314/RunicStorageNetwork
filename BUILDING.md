...
They cover resource planning, network graphs, reservations, recovery, localization and resource counts. They do not simulate Valheim networking, Harmony patches or the game UI; multiplayer changes also need in-game testing.
