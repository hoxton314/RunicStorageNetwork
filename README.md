...
The network works with supported stationary chests in loaded areas of the world. Remote storage in unloaded areas is not supported. Backpacks, tombstones, and ship storage are not connected.
...
Сеть работает с поддерживаемыми стационарными сундуками в загруженной области мира. Доступ к удалённым выгруженным складам не поддерживается. Рюкзаки, надгробия и корабельные трюмы не подключаются.
