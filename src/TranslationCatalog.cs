...
namespace RunicStorageNetwork {
 ...
 internal static class TranslationCatalog {
  ...
  static TranslationCatalog(){
   ...
   Add("containers","Local chests:","Местных сундуков:");
   Add("network_containers","Network chests:","Сундуков в сети:");
   Add("link","Link range","Радиус связи");Add("storage","Chest range","Радиус сундуков");Add("supply","Supply range","Радиус снабжения");
   Add("metres","m","м");
